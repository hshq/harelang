...
rt_ha = rt/+aarch64/arch_jmp.ha rt/+aarch64/cpuid.ha rt/+darwin/+aarch64.ha rt/+darwin/env.ha rt/+darwin/errno.ha rt/+darwin/initfini.ha rt/+darwin/platform_abort.ha rt/+darwin/platformstart-libc.ha rt/+darwin/segmalloc.ha rt/+darwin/signal.ha rt/+darwin/socket.ha rt/+darwin/start.ha rt/+darwin/syscallno.ha rt/+darwin/syscalls.ha rt/+darwin/types.ha rt/abort.ha rt/ensure.ha rt/fenv_defs.ha rt/jmp.ha rt/malloc.ha rt/memcpy.ha rt/memfunc_ptr.ha rt/memmove.ha rt/memset.ha rt/strcmp.ha rt/u64tos.ha rt/unknown_errno.ha
...
io_ha = io/+darwin/dup.ha io/+darwin/mmap.ha io/+darwin/platform_file.ha io/+darwin/sync.ha io/+darwin/vector.ha io/arch+aarch64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/util.ha io/zero.ha
