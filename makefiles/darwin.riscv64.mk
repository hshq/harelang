...
TDENV = env HARE_TD_rt=$(HARECACHE)/std/rt.td HARE_TD_types=$(HARECACHE)/std/types.td HARE_TD_bytes=$(HARECACHE)/std/bytes.td HARE_TD_encoding::utf8=$(HARECACHE)/std/encoding_utf8.td HARE_TD_sort::cmp=$(HARECACHE)/std/sort_cmp.td HARE_TD_strings=$(HARECACHE)/std/strings.td HARE_TD_ascii=$(HARECACHE)/std/ascii.td HARE_TD_errors=$(HARECACHE)/std/errors.td HARE_TD_io=$(HARECACHE)/std/io.td HARE_TD_bufio=$(HARECACHE)/std/bufio.td HARE_TD_crypto::math=$(HARECACHE)/std/crypto_math.td HARE_TD_endian=$(HARECACHE)/std/endian.td HARE_TD_hash=$(HARECACHE)/std/hash.td HARE_TD_crypto::sha256=$(HARECACHE)/std/crypto_sha256.td HARE_TD_math=$(HARECACHE)/std/math.td HARE_TD_memio=$(HARECACHE)/std/memio.td HARE_TD_path=$(HARECACHE)/std/path.td HARE_TD_time=$(HARECACHE)/std/time.td HARE_TD_fs=$(HARECACHE)/std/fs.td HARE_TD_types::c=$(HARECACHE)/std/types_c.td HARE_TD_os=$(HARECACHE)/std/os.td HARE_TD_strconv=$(HARECACHE)/std/strconv.td HARE_TD_fmt=$(HARECACHE)/std/fmt.td HARE_TD_encoding::hex=$(HARECACHE)/std/encoding_hex.td HARE_TD_sort=$(HARECACHE)/std/sort.td HARE_TD_hare::lex=$(HARECACHE)/std/hare_lex.td HARE_TD_hare::ast=$(HARECACHE)/std/hare_ast.td HARE_TD_hare::parse=$(HARECACHE)/std/hare_parse.td HARE_TD_hare::unparse=$(HARECACHE)/std/hare_unparse.td HARE_TD_hare::module=$(HARECACHE)/std/hare_module.td HARE_TD_unix=$(HARECACHE)/std/unix.td HARE_TD_unix::signal=$(HARECACHE)/std/unix_signal.td HARE_TD_os::exec=$(HARECACHE)/std/os_exec.td HARE_TD_shlex=$(HARECACHE)/std/shlex.td HARE_TD_unix::tty=$(HARECACHE)/std/unix_tty.td HARE_TD_cmd::hare::build=$(HARECACHE)/std/cmd_hare_build.td HARE_TD_dirs=$(HARECACHE)/std/dirs.td HARE_TD_getopt=$(HARECACHE)/std/getopt.td HARE_TD_cmd::hare=$(HARECACHE)/std/cmd_hare.td
RTSCRIPT = rt/+darwin/stub.hare.sc
OBJS = $(HARECACHE)/std/rt.o $(HARECACHE)/std/types.o $(HARECACHE)/std/bytes.o $(HARECACHE)/std/encoding_utf8.o $(HARECACHE)/std/sort_cmp.o $(HARECACHE)/std/strings.o $(HARECACHE)/std/ascii.o $(HARECACHE)/std/errors.o $(HARECACHE)/std/io.o $(HARECACHE)/std/bufio.o $(HARECACHE)/std/crypto_math.o $(HARECACHE)/std/endian.o $(HARECACHE)/std/hash.o $(HARECACHE)/std/crypto_sha256.o $(HARECACHE)/std/math.o $(HARECACHE)/std/memio.o $(HARECACHE)/std/path.o $(HARECACHE)/std/time.o $(HARECACHE)/std/fs.o $(HARECACHE)/std/types_c.o $(HARECACHE)/std/os.o $(HARECACHE)/std/strconv.o $(HARECACHE)/std/fmt.o $(HARECACHE)/std/encoding_hex.o $(HARECACHE)/std/sort.o $(HARECACHE)/std/hare_lex.o $(HARECACHE)/std/hare_ast.o $(HARECACHE)/std/hare_parse.o $(HARECACHE)/std/hare_unparse.o $(HARECACHE)/std/hare_module.o $(HARECACHE)/std/unix.o $(HARECACHE)/std/unix_signal.o $(HARECACHE)/std/os_exec.o $(HARECACHE)/std/shlex.o $(HARECACHE)/std/unix_tty.o $(HARECACHE)/std/cmd_hare_build.o $(HARECACHE)/std/dirs.o $(HARECACHE)/std/getopt.o $(HARECACHE)/std/cmd_hare.o

rt_ha = rt/+darwin/+riscv64.ha rt/+darwin/env.ha rt/+darwin/errno.ha rt/+darwin/initfini.ha rt/+darwin/platform_abort.ha rt/+darwin/platformstart-libc.ha rt/+darwin/segmalloc.ha rt/+darwin/signal.ha rt/+darwin/socket.ha rt/+darwin/start.ha rt/+darwin/syscallno.ha rt/+darwin/syscalls.ha rt/+darwin/types.ha rt/+riscv64/arch_jmp.ha rt/+riscv64/cpuid.ha rt/abort.ha rt/ensure.ha rt/fenv_defs.ha rt/jmp.ha rt/malloc.ha rt/memcpy.ha rt/memfunc_ptr.ha rt/memmove.ha rt/memset.ha rt/strcmp.ha rt/u64tos.ha rt/unknown_errno.ha
$(HARECACHE)/std/rt.ssa: $(rt_ha)
	@mkdir -p -- "$(HARECACHE)/std"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/std/rt.td.tmp -N rt $(rt_ha)

rt_s = $(HARECACHE)/std/rt.s rt/+darwin/@func-libc.s rt/+riscv64/cpuid.s rt/+riscv64/fenv.s rt/+riscv64/longjmp.s rt/+riscv64/setjmp.s
...
io_ha = io/+darwin/dup.ha io/+darwin/mmap.ha io/+darwin/platform_file.ha io/+darwin/sync.ha io/+darwin/vector.ha io/arch+riscv64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/util.ha io/zero.ha
...
path_ha = path/+darwin.ha path/buffer.ha path/error.ha path/ext_stack.ha path/iter.ha path/posix.ha path/prefix.ha path/stack.ha
...
time_ha = time/+darwin/functions.ha time/arithm.ha time/conv.ha time/types.ha
...
os_ha = os/+darwin/dirfdfs.ha os/+darwin/exit.ha os/+darwin/fcntl.ha os/+darwin/fs.ha os/+darwin/platform_environ.ha os/+darwin/shm.ha os/+darwin/status.ha os/+darwin/stdfd.ha os/environ.ha os/os.ha
$(HARECACHE)/std/os.ssa: $(os_ha) $(HARECACHE)/std/bufio.td $(HARECACHE)/std/encoding_utf8.td $(HARECACHE)/std/errors.td $(HARECACHE)/std/fs.td $(HARECACHE)/std/io.td $(HARECACHE)/std/path.td $(HARECACHE)/std/rt.td $(HARECACHE)/std/strings.td $(HARECACHE)/std/time.td $(HARECACHE)/std/types_c.td
	@mkdir -p -- "$(HARECACHE)/std"
...
$(HARECACHE)/std/strconv.ssa: $(strconv_ha) $(HARECACHE)/std/ascii.td $(HARECACHE)/std/bytes.td $(HARECACHE)/std/io.td $(HARECACHE)/std/math.td $(HARECACHE)/std/memio.td $(HARECACHE)/std/strings.td $(HARECACHE)/std/types.td
	@mkdir -p -- "$(HARECACHE)/std"
...
$(HARECACHE)/std/hare_module.ssa: $(hare_module_ha) $(HARECACHE)/std/ascii.td $(HARECACHE)/std/bufio.td $(HARECACHE)/std/bytes.td $(HARECACHE)/std/encoding_utf8.td $(HARECACHE)/std/fmt.td $(HARECACHE)/std/fs.td $(HARECACHE)/std/hare_ast.td $(HARECACHE)/std/hare_lex.td $(HARECACHE)/std/hare_parse.td $(HARECACHE)/std/hare_unparse.td $(HARECACHE)/std/io.td $(HARECACHE)/std/memio.td $(HARECACHE)/std/os.td $(HARECACHE)/std/path.td $(HARECACHE)/std/sort.td $(HARECACHE)/std/sort_cmp.td $(HARECACHE)/std/strings.td $(HARECACHE)/std/time.td
	@mkdir -p -- "$(HARECACHE)/std"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/std/hare_module.td.tmp -N hare::module $(hare_module_ha)

unix_ha = unix/+darwin/creds.ha unix/+darwin/nice.ha unix/+darwin/pipe.ha unix/+darwin/umask.ha
...
os_exec_ha = os/exec/+darwin/exec.ha os/exec/+darwin/platform_cmd.ha os/exec/+darwin/process.ha os/exec/cmd.ha os/exec/types.ha
...
unix_tty_ha = unix/tty/+darwin/isatty.ha unix/tty/+darwin/open.ha unix/tty/+darwin/pgid.ha unix/tty/+darwin/pty.ha unix/tty/+darwin/termios.ha unix/tty/+darwin/winsize.ha unix/tty/types.ha
$(HARECACHE)/std/unix_tty.ssa: $(unix_tty_ha) $(HARECACHE)/std/errors.td $(HARECACHE)/std/fs.td $(HARECACHE)/std/io.td $(HARECACHE)/std/os.td $(HARECACHE)/std/os_exec.td $(HARECACHE)/std/rt.td $(HARECACHE)/std/types_c.td
	@mkdir -p -- "$(HARECACHE)/std"
...
cmd_hare_ha = cmd/hare/arch.ha cmd/hare/build.ha cmd/hare/cache.ha cmd/hare/deps.ha cmd/hare/error.ha cmd/hare/init+darwin.ha cmd/hare/main.ha cmd/hare/util.ha cmd/hare/version.ha
$(HARECACHE)/std/cmd_hare.ssa: $(cmd_hare_ha) $(HARECACHE)/std/ascii.td $(HARECACHE)/std/bufio.td $(HARECACHE)/std/cmd_hare_build.td $(HARECACHE)/std/crypto_sha256.td $(HARECACHE)/std/dirs.td $(HARECACHE)/std/errors.td $(HARECACHE)/std/fmt.td $(HARECACHE)/std/fs.td $(HARECACHE)/std/getopt.td $(HARECACHE)/std/hare_ast.td $(HARECACHE)/std/hare_lex.td $(HARECACHE)/std/hare_module.td $(HARECACHE)/std/hare_parse.td $(HARECACHE)/std/hash.td $(HARECACHE)/std/io.td $(HARECACHE)/std/memio.td $(HARECACHE)/std/os.td $(HARECACHE)/std/os_exec.td $(HARECACHE)/std/path.td $(HARECACHE)/std/shlex.td $(HARECACHE)/std/sort.td $(HARECACHE)/std/sort_cmp.td $(HARECACHE)/std/strconv.td $(HARECACHE)/std/strings.td $(HARECACHE)/std/unix_tty.td
	@mkdir -p -- "$(HARECACHE)/std"
