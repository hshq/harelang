...
rt_s = $(HARECACHE)/std/rt.s rt/+openbsd/start.s rt/+riscv64/cpuid.s rt/+riscv64/fenv.s rt/+riscv64/longjmp.s rt/+riscv64/setjmp.s
...
$(HARECACHE)/std/unix_signal.ssa: $(unix_signal_ha) $(HARECACHE)/std/errors.td $(HARECACHE)/std/rt.td $(HARECACHE)/std/unix.td
	@mkdir -p -- "$(HARECACHE)/std"
