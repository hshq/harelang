...
rt_ha = rt/+darwin/+x86_64.ha rt/+darwin/env.ha rt/+darwin/errno.ha rt/+darwin/platform_abort.ha rt/+darwin/platformstart.ha rt/+darwin/segmalloc.ha rt/+darwin/signal.ha rt/+darwin/socket.ha rt/+darwin/syscallno.ha rt/+darwin/syscalls.ha rt/+darwin/types.ha rt/+x86_64/arch_jmp.ha rt/+x86_64/backtrace.ha rt/+x86_64/cpuid.ha rt/abort.ha rt/ensure.ha rt/fenv_defs.ha rt/initfini.ha rt/jmp.ha rt/malloc.ha rt/memcpy.ha rt/memfunc_ptr.ha rt/memmove.ha rt/memset.ha rt/start.ha rt/strcmp.ha rt/u64tos.ha rt/unknown_errno.ha
...
os_exec_ha = os/exec/cmd.ha os/exec/exec+darwin.ha os/exec/process+darwin.ha os/exec/types.ha
...
unix_tty_ha = unix/tty/+darwin/isatty.ha unix/tty/+darwin/open.ha unix/tty/+darwin/pty.ha unix/tty/+darwin/termios.ha unix/tty/+darwin/winsize.ha unix/tty/pty_common.ha unix/tty/types.ha
